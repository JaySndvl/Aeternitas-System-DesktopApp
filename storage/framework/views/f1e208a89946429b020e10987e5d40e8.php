...
<head>
    <meta charset="utf-8">
    <title>Payroll Export - <?php echo e($start_date); ?> to <?php echo e($end_date); ?></title>
    <style>
        body {
...
<body>
    <div class="header">
        <h1><?php echo e($company->name ?? 'Company'); ?> - Payroll Report</h1>
        <p>Period: <?php echo e(\Carbon\Carbon::parse($start_date)->format('M d, Y')); ?> to <?php echo e(\Carbon\Carbon::parse($end_date)->format('M d, Y')); ?></p>
    ...
    <table>
        ...
        <tbody>
            ...
            <?php $__currentLoopData = $payrolls; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $payroll): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                ...
                ?>
                <tr>
                    <td><?php echo e($employee->employee_id ?? 'N/A'); ?></td>
                    ...
                    <td class="text-right">₱<?php echo e(number_format($overtimePay, 2)); ?></td>
                    <td class="text-right">₱<?php echo e(number_format($allowances, 2)); ?></td>
                    <td class="text-right">₱<?php echo e(number_format($deductions, 2)); ?></td>
                    <td class="text-right">₱<?php echo e(number_format($grossPay, 2)); ?></td>
                    <td class="text-right">₱<?php echo e(number_format($netPay, 2)); ?></td>
                    <td class="text-center"><?php echo e(ucfirst($payroll->status)); ?></td>
                </tr>
        ...
        <tfoot>
            <tr style="background-color: #e2e8f0; font-weight: bold;">
                ...
                <td class="text-right">₱<?php echo e(number_format($totalBasicSalary, 2)); ?></td>
                <td class="text-right">₱<?php echo e(number_format($totalOvertime, 2)); ?></td>
                <td class="text-right">₱<?php echo e(number_format($totalAllowances, 2)); ?></td>
                <td class="text-right">₱<?php echo e(number_format($totalDeductions, 2)); ?></td>
                <td class="text-right">₱<?php echo e(number_format($totalGrossPay, 2)); ?></td>
                <td class="text-right">₱<?php echo e(number_format($totalNetPay, 2)); ?></td>
                <td></td>
            </tr>
        </tfoot>
    </table>
    ...
    <div class="summary">
        <div class="summary-row">
            ...
            <span><?php echo e($payrolls->count()); ?></span>
        </div>
        <div class="summary-row">
            <span>Total Gross Pay:</span>
            <span>₱<?php echo e(number_format($totalGrossPay, 2)); ?></span>
        </div>
        <div class="summary-row">
            <span>Total Net Pay:</span>
            <span>₱<?php echo e(number_format($totalNetPay, 2)); ?></span>
        </div>
    </div>
</body>
</html>

<?php /**PATH C:\Users\caior\Documents\Mica files\Aeternitas-System-V2\resources\views/payroll/export-pdf.blade.php ENDPATH**/ ?>